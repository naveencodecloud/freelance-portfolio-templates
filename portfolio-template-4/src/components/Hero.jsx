            ...
            <nav className="w-full max-w-6xl mx-auto px-6 py-5">
                <div className="glass rounded-2xl px-6 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="mailto:hello@site.com" className="text-sm px-4 py-2 rounded-lg bg-violet-600 text-white font-medium hover:bg-violet-500 transition-colors no-underline hover:no-underline">Contact</a>
                    </div>
                </div>
            </nav>
            ...
            <section className="w-full max-w-6xl mx-auto px-6 pt-16 pb-24 animate-fade-in">
                <div className="text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        <a href="mailto:hello@site.com" className="inline-flex items-center gap-2 px-6 py-3 bg-linear-to-r from-violet-600 to-violet-500 text-white font-semibold rounded-xl hover:opacity-90 transition-opacity no-underline hover:no-underline glow">
