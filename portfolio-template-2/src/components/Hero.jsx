                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-16 animate-fade-in">
                    <div className="max-w-xl">
                        ...
                        <div className="flex flex-wrap gap-3">
                            <a href="mailto:hello@site.com" className="inline-flex items-center gap-2 px-5 py-3 bg-zinc-900 dark:bg-zinc-50 text-zinc-50 dark:text-zinc-900 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity no-underline hover:no-underline">
