    ...
    return (
        <footer className="w-full max-w-7xl mx-auto px-6 py-10 border-t border-zinc-100 dark:border-zinc-800 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-5">
                <a href="mailto:hello@example.com" className="text-sm text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors no-underline hover:no-underline">hello@example.com</a>
